  ...
  public:
	                ...
	                size_t                                _nCaloTrig)
	{
		for(unsigned int i = 0; i < _nTrackTrig; ++i)
		{
			...
			this->Hist._hOccInfo[i][0] =
			    occInfoDir.make<TH1F>(Form("hInstLum_%i", i),
			                          "distrbution of instantaneous lum; p/#mu-bunch",
			                          1000,
			                          1e6,
			                          4e8);
		...
		this->Hist._hOccInfo[index_last][0] =
	...
	void BookHistos(TDirectory* occInfoDir, size_t _nTrackTrig, size_t _nCaloTrig)
	{
		...
		this->Hist._hOccInfo[index_last][0] =
		    new TH1F(Form("hInstLum_%i", index_last),
		             "distrbution of instantaneous lum; p/#mu-bunch",
		             1000,
		             1e6,
		             4e8);
